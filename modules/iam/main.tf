...
# CloudWatch Logs Policy for EKS control plane logging
resource "aws_iam_policy" "eks_cloudwatch_logs" {
  name        = "${var.project_name}-${var.environment}-eks-cloudwatch-logs"
  description = "Allow EKS to write logs to CloudWatch"
